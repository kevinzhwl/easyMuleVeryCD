/* 
 * $Id: SearchManager.h 18513 2010-03-24 09:41:45Z huby $
 * 
...
namespace Kademlia
{
	...
	class CSearchManager
	{
		...
		public:
			...
			static CSearch* PrepareFindKeywords(bool bUnicode, LPCTSTR szKeyword, UINT uSearchTermsSize, LPBYTE pucSearchTermsData,UINT uSearchID=0);
