/* 
 * $Id: NextVersion.h 20251 2010-07-22 06:49:14Z dgkang $
 * 
...
#define VC_VERSION_BUILD %shortdate%//Added by thilon on 2006.01.10
									// auto-modify by linhai on 2007.11.28

#define EASYMULE_MJR	1		//	<major>		major number (e.g. 0)
#define EASYMULE_MIN	1		//	<minor>		minor number (e.g. 30)
#define	EASYMULE_UPDATE 15		//	<update>	update number (e.g. 0='a'  1='b'  2='c'  3='d'  4='e'  5='f' ...)
