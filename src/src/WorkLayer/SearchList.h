/* 
 * $Id: SearchList.h 14469 2009-07-20 10:24:59Z huby $
 * 
...
public:
	...
	bool	AddToList(CSearchFile* toadd, bool bClientResponse = false, uint32 dwFromUDPServerIP = 0,bool bWM_AddResult = true,bool bVerifyWordFilter=true,bool bDoSpamRating=true);
	...
	void	AddResults( SearchListsStruct * pSearchListsStruct );
