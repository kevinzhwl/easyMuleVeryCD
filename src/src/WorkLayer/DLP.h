/* 
 * $Id: DLP.h 15538 2009-09-07 09:37:30Z huby $
 * 
...
public:
	...
	typedef LPCTSTR (__cdecl *DLPCHECK_NONSTANDARD)(LPCTSTR modversion, LPCTSTR clientversion, LPCTSTR username);
	DLPCHECK_NONSTANDARD DLPCheck_NonStandard;
