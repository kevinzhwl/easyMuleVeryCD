...
static char* pinyin_utf8 = NULL;

static char pinyin_utf8_1[] = 
"一yi\0"
"丁ding zheng\0"
"丂kao yu\0"
"七qi\0"
...
static int get_part_len(char* p)
{
	if (p == NULL)
		return 0;
...
static bool merge()
{
	if (pinyin_utf8 == NULL)
	{
		int part_len_1 = get_part_len(pinyin_utf8_1);
		int part_len_2 = get_part_len(pinyin_utf8_2);
		int part_len_3 = get_part_len(pinyin_utf8_3);

		pinyin_utf8 = (char*)malloc(part_len_1 + part_len_2 + part_len_3);

		int index = 0;
		memcpy(pinyin_utf8 + index ,pinyin_utf8_1,part_len_1);
		index += part_len_1;

		memcpy(pinyin_utf8 + index ,pinyin_utf8_2,part_len_2);
		index += part_len_2;

		memcpy(pinyin_utf8 + index ,pinyin_utf8_3,part_len_3);
