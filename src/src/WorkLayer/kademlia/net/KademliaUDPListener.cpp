/* 
 * $Id: KademliaUDPListener.cpp 13559 2009-06-09 06:57:05Z huby $
 * 
			...
			if(pTag)
			{
				...
				else if (!pTag->m_name.Compare(TAG_SOURCEPORT))
				{
					...
					else
					{
						...
						if(pSourcePortTag1)
						{
							pEntry->RemoveTag(pSourcePortTag1);
							delete pSourcePortTag1;
							pSourcePortTag1 = NULL;
						}
						pEntry->m_uTCPPort = (uint16)pTag->GetInt();												
						pEntry->AddTag(pTag);												
					}
