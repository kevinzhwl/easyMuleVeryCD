/* 
 * $Id: SearchManager.cpp 18513 2010-03-24 09:41:45Z huby $
 * 
...
CSearch* CSearchManager::PrepareFindKeywords(bool bUnicode, LPCTSTR szKeyword, UINT uSearchTermsSize, LPBYTE pucSearchTermsData,UINT uSearchID/*=0*/)
{
