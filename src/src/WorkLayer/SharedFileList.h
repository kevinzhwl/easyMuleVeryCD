/* 
 * $Id: SharedFileList.h 19524 2010-05-20 10:09:21Z dgkang $
 * 
...
class CServer;
class CCollection;
typedef struct _PublishFileSt PublishFileSt;
...
public:
	...
	void	GetSharedFilelist(CArray<PublishFileSt,PublishFileSt&>& ls);

	void	Reload();
	void	AutoReload(BOOL bUpdateUI);
