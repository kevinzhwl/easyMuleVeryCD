/* 
 * $Id: ZIPFile.cpp 19812 2010-06-08 11:34:14Z dgkang $
 * 
 *  ZIPFile.cpp
 * 
...
//modify by zhuhui on 2010-5-27:与emule 0.50a同步
...
BOOL CZIPFile::File::Extract(LPCTSTR pszFile)
{
	...
	{
		CloseHandle(hFile);       //add by zhuhui on 2010-5-27 :同步emule0.50a,句柄泄露
		DeleteFile(pszFile);      //add by zhuhui on 2010-5-27 :同步emule0.50a,内存可能泄露
		return NULL;
	}
