/* 
 * $Id: DownloadListCtrl.h 20835 2010-11-18 10:36:09Z dgkang $
 * 
...
public:
	...
	void	FilterItemsBySearchKey(CString* searchKey); // ×Ö·û´®Æ¥ÅäÉ¸Ñ¡
...
protected:
	...
	StringMatcher m_stringMatcher; // ×Ö·û´®Æ¥ÅäÉ¸Ñ¡
