/*
 * $Id: stdafx.h 20251 2010-07-22 06:49:14Z dgkang $
 * 
...
#if _MSC_VER < 1400
#error C++ compiler version too lower.
#endif
#endif

#if _MSC_VER >=  1400
	#ifndef WINVER
	#define WINVER 0x601			// 0x0400 == Windows 98 and Windows NT 4.0 (because of '_WIN32_WINDOWS=0x0410')
	#endif

	#ifndef _WIN32_WINNT
	#define _WIN32_WINNT WINVER		// 0x0400 == Windows NT 4.0
	#endif
#else
	#ifndef WINVER
	#define WINVER 0x0500			// 0x0400 == Windows 98 and Windows NT 4.0 (because of '_WIN32_WINDOWS=0x0410')
	#endif

	#ifndef _WIN32_WINNT
	#define _WIN32_WINNT 0x0500		// 0x0400 == Windows NT 4.0
	#endif
#endif
