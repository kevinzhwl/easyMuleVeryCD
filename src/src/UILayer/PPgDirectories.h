/*
 * $Id: PPgDirectories.h 12904 2009-05-15 06:21:43Z dgkang $
 * 
...
public:
	...
	afx_msg void OnEnChangeTempfiles();
	afx_msg void OnBnClickedFlushsharedir();
	afx_msg void OnEnChangeIntervalEdit();
};
