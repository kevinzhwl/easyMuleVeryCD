/*
 * $Id: GlobalVariable.h 19524 2010-05-20 10:09:21Z dgkang $
 * 
...
class CDNSManager;
class CFileMgr;
class CIntelligentUploadManager;// VC-jimmyc[2010/4/8]
class CDlgMainTabRss;
...
public:
	...
	static CIntelligentUploadManager *s_IntelligentUploadManager;		// VC-jimmyc[2010/4/8]
	...
	static struct	Country_Struct* m_pMyCountry;
	...
	static const UINT	m_nVCVersionBld;	//Added by thilon on 2006.01.10, for VeryCD°æBuildºÅ
	...
	// ¶©ÔÄ¿ØÖÆ´°¿Ú
	static CDlgMainTabRss *	s_wndRssCtrl;
...
public:
	...
	static int GetCountryFlagIndex();
