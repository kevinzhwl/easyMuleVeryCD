/*
 * $Id: ini2.cpp 19246 2010-04-29 08:23:47Z dgkang $
 * 
...
//ADDED by VC-yavey on 2010-03-17	<begin>
// É¾³ýsection
void CIni::DeleteSection(LPCTSTR pszSection /*= NULL*/)
{
	if ( pszSection == NULL )
	{
		pszSection = m_strSection;
	}
	WritePrivateProfileString(pszSection, NULL, NULL, m_strFileName);
}
//ADDED by VC-yavey on 2010-03-17	<end>
