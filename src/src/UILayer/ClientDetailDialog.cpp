/* 
 * $Id: ClientDetailDialog.cpp 19524 2010-05-20 10:09:21Z dgkang $
 * 
...
LRESULT CClientDetailPage::WindowProc( UINT message, WPARAM wParam, LPARAM lParam )
{
...
LRESULT CClientDetailDialog::WindowProc( UINT message, WPARAM wParam, LPARAM lParam )
{
	if ( WM_INPUTLANGCHANGEREQUEST == message )
	{
		if(GetKeyboardLayout(0) == (HKL)lParam)
