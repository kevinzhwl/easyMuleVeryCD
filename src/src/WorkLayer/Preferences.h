/* 
 * $Id: Preferences.h 20835 2010-11-18 10:36:09Z dgkang $
 * 
...
enum EDefaultDirectory{
	...
	EMULE_TEMPDIR = 16,
	EMULE_POSTER = 17 //存储RSS 海报 folder
};
...
public:
	...
	static  CString m_LastUpdateHash;
	...
	static SIZE		m_sizeInfoWindow;
	static CString  m_strInfoWindowURL;
	static time_t   m_tInfoWindowLastActiveTime;
	static DWORD	m_dwInfoWindowActiveSpan;
	// add by jimmyc [2010-4-13]
	static int m_nMaintabDownloadLastActiveTab;
	enum Table
	{
		tableDownload, 
		tableUpload, 
...
//	friend class CPPgSecurity;
	...
	static int		GetMaintabDownloadLastActiveTab()	{return m_nMaintabDownloadLastActiveTab;}
	static void		SetMaintabDownloadLastActiveTab(int nLastTab) {m_nMaintabDownloadLastActiveTab = nLastTab;}
	// ZZ:UploadSpeedSense -->
...
public:
	...
	static uint8	m_TestVer;

// added by vc-yavey on 20100429 : config rss <begin>
#if !defined(_DEBUG)
	static const UINT DEFAULT_UPDATE_FEED_INTERVAL_SECOND = 30 * 60;	///< 30 min for release
#else
	static const UINT DEFAULT_UPDATE_FEED_INTERVAL_SECOND = 5 * 60;		///< 5 min for debug
#endif
	static UINT		m_uRssUpdateInterval;
	static bool		m_bRssAutoDownload;
