/* 
 * $Id: SearchFile.h 14238 2009-07-08 10:04:38Z dgkang $
 * 
...
public:
	...
	CSearchFile(uint32 nSearchID,LPCTSTR szFileName,EMFileSize nFileSize,int nCompleteCount,int nWeeklyStart,LPCSTR szHash);
