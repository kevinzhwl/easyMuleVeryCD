/*
 * $Id: GlobalVariable.cpp 19246 2010-04-29 08:23:47Z dgkang $
 * 
...
Country_Struct* CGlobalVariable::m_pMyCountry = NULL;
...
CIntelligentUploadManager* CGlobalVariable::s_IntelligentUploadManager = NULL;		// VC-jimmyc[2010/4/8]
...
// ¶©ÔÄ¿ØÖÆ´°¿Ú
CDlgMainTabRss * CGlobalVariable::s_wndRssCtrl = NULL;
...
int CGlobalVariable::GetCountryFlagIndex()
{
	return (NULL == m_pMyCountry) ? 0 : m_pMyCountry->FlagIndex;
}
