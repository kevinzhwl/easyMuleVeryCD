/* 
 * $Id: otherfunctions.h 20689 2010-10-20 04:12:33Z dgkang $
 * 
...
CString URLEncode(const CString& sIn,bool bUtf8=false,bool bEncodeReserved=true);
...
CString	CreateED2kLink(const CAbstractFile* f, bool bEscapeLink = true,bool bKeepSpaces = false);
...
#define _WINVER_WIN7_	0x0601	// 6.1
