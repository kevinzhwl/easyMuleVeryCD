/*
 * $Id: UIMessage.h 20835 2010-11-18 10:36:09Z dgkang $
 * 
...
//CDlgMainTabRss
#define WM_RSS_FEED_UPDATE				(WM_UIMSG_BASE + 180)
#define WM_RSS_REQ_DOWNLOAD_FILE		(WM_UIMSG_BASE + 181)

//CDlgAddTask edit
#define WM_ADDTASK_RSS_UPDATE			(WM_UIMSG_BASE + 182)

//CDlgMainTabRss
#define WM_RSS_POSTER_UPDATE			(WM_UIMSG_BASE + 183)

//SeachEdit
#define WM_SEARCHEDIT_CHANGE			(WM_UIMSG_BASE + 184)
#define WM_SEARCHEDIT_ONKEYDOWN			(WM_UIMSG_BASE + 185)